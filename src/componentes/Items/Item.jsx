...
function Item(productos) {
  ...
  return (
        <Container >
            <Card  key={productos.id}style={{ width: '20rem',height:'32rem'}}  >
                ...
                <Card.Body >
                    ...
                    <Card.Text>
                        <Link to={`/Item/${productos.id}`} style={{ textDecoration: 'none',textAlign:'center',fontWeight:'700'}}><p >Mas Informacion</p></Link>
                    </Card.Text>
                </Card.Body>
            </Card>
        </Container>
